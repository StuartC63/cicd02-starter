pipeline {
    agent any
    environment {
        TF_VAR_gcp_project = "qwiklabs-gcp-02-fc656c8d435d"
        TF_VAR_bucket = "tf-remote-state-student_04_e12d3ad3a488-22531-20869"
        REPOSITORY = "https://github.com/StuartC63/cicd02-starter"
